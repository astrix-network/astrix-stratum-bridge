...
import (
	...
	"github.com/astrix-network/astrix-stratum-bridge/src/astrixstratum"
	"gopkg.in/yaml.v2"
)
...
func main() {
	...
	flag.StringVar(&cfg.RPCServer, "astrix", cfg.RPCServer, "address of the astrixd node, default `localhost:42110`")
